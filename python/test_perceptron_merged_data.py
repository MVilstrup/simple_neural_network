...
target = data_file.iloc[50:150, 4].values

# Set setosa to be the class -1 and versicolor to be the class 1
target = np.where(target == "Iris-virginica", -1, 1)

# Set the training data to be the sepal and petal length of the two kinds of iris
training_data = data_file.iloc[50:150, [1,3]].values

perceptron = Perceptron(passes=25, learning_rate=0.1)
